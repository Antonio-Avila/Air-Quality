...
test_day <- daily_max_counties %>% filter(date_local == "2017-09-03")
...
p <-  plot_usmap(include = "TX") +
        ...
        scale_fill_gradient2(low = "green", high = "red", midpoint = 65, mid = "orange", limits = c(0, 120)) +
        labs(fill = "Ozone Level")

ggplotly(p, tooltip = "text", height = 200, width = 200)
