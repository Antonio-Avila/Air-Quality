...
```{r creating a forecasting function}
# Tried to fit an arima model using the auto.arima function, knowing it wasn't going to perform well. But damn, wasnt expecting it to be this bad.
