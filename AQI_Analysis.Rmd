...
To determine if pm2.5 levels has an impact on the number of covid related deaths, I found the number of days a county had high levels of pm2.5 (greater than 12) per month and compared it to the number of deaths. There seems to be a partial relationship between the two variables since covid deaths tend to spike after 
