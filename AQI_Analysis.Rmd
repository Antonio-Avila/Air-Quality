...
start_time = proc.time()
pm2.5_texas_2020 <- aqs_sampledata_by_state(parameter = "88101",
                                           bdate = as.Date("20200901",
                                                           format="%Y%m%d"
                                                           ),
                                           edate = as.Date("20210901",
...
write_csv(pm2.5_texas_2020, "pm2.5_texas_2020.csv")
print("Time to Execute:")
print(proc.time() - start_time)
beep()
```
...
# write_csv(daily_max_counties, "daily_max_counties.csv")
```
